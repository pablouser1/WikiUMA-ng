...
<section class="section">
    <div class="content">
        <!-- TODO: Añadir texto contando la vida -->
        <p>WikiUMA <small>ng</small> aspira a continuar el funcionamiento de su antecesor.
    </div>
    <div class="content">
        ...
        <ul>
            ...
            <li><a rel="nofollow"
                    href="https://github.com/developerdino/ProfanityFilter">developerdino/ProfanityFilter</a> (con
                algunas modificaciones)</li>
        </ul>
    </div>
</section>
