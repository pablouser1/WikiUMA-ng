<nav class="navbar is-transparent" role="navigation" aria-label="main navigation">
  <div class="navbar-brand">
    <a href="<?=$this->url('/')?>" class="navbar-item">
      <?= $this->insert('components/icon/main', ['icon' => 'home', 'text' => 'WikiUMA-ng']) ?>
    </a>
  ...
  <div id="navbar-menu" class="navbar-menu">
    ...
    <div class="navbar-end">
      ...
      <div class="navbar-item has-dropdown is-hoverable">
        <a class="navbar-link">
          <?= $this->insert('components/icon/main', ['icon' => 'user', 'text' => $this->e($_SESSION['niu'])]) ?>
        </a>
          ...
          <div class="buttons">
            ...
            <?php if ($this->mode() !== 0): ?>
                <a href="/register" class="button is-primary">
                  <?= $this->insert('components/icon/main', ['icon' => 'user-add', 'text' => 'Registrarse']) ?>
                </a>
            <?php endif ?>
          </div>
        </div>
